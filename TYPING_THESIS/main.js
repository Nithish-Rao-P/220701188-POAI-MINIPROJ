...
function showResult() {
  ...
  document.querySelector('#right-wing').innerHTML = `WPM: ${wpm} / ACC: ${acc}`;
    // Create a form and submit WPM and ACC to PHP
    let form = document.createElement('form');
    form.method = 'POST';
    form.action = 'update.php'; // The PHP page that will process and update the session variables.
  
    let wpmInput = document.createElement('input');
